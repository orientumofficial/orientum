...
void ThreadMapPort()
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "Orientum " + FormatFullVersion();
...
unsigned int pnSeed[] =
{
    0x69cfbcc7, 0x98ccbcc7, 0xfd7640c0, 0xb0ffd5a2, 0xbdffd5a2, 0xc37240c0, 0x3714c0c7, 0x0e1ebbc6
};
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. Orientum is probably already running."), addrBind.ToString().c_str());
        else
